  ...
  return (
    <section className="py-24 md:py-32 px-8 md:px-12 bg-[#FAFAFA]">
      <div className="max-w-5xl mx-auto">
        ...
        >
          <blockquote className="text-2xl md:text-3xl lg:text-4xl font-light text-black leading-[1.3] tracking-[-0.01em] mb-12">
            "{testimonial.quote}"
          </blockquote>
          
          <div className="w-16 h-px bg-[#B7C9B7]/20 mx-auto mb-8"></div>
