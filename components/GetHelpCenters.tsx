  ...
  return (
    <section className="relative h-[80vh] min-h-[700px] w-full overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 flex items-center z-10">
        <div className="w-full max-w-[90rem] mx-auto px-8 md:px-12">
              ...
              >
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-3 text-white/90">
                    ...
                    <a href={`tel:${centers[currentIndex].contact.phone.replace(/\D/g, '')}`} 
                       className="text-lg hover:text-[#B7C9B7] transition-colors">
                ...
                <Link href={centers[currentIndex].href} className="mt-8 block">
                  <button className="group relative text-white text-sm tracking-widest uppercase font-medium">
                    <span className="relative z-10 px-10 py-4 block">Get Treatment Here</span>
