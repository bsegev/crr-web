...
export default function GetHelpCTA() {
  return (
    <section className="py-20 sm:py-32 px-4 sm:px-6 bg-gradient-to-br from-[#06402B] to-[#06402B]/90 relative overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center">
            ...
            <Link href="/contact" className="w-full sm:w-auto">
              <Button
                size="lg"
                variant="outline"
                className="border-2 border-white text-white hover:bg-white/10 shadow-lg hover:shadow-xl transition-all duration-300 h-14 w-full px-8 sm:px-10 text-base sm:text-lg"
              >
                Contact Us
