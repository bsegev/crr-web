...
const FinalCTA = () => {
  return (
    <section className="py-16 sm:py-20 md:py-24 lg:py-32 px-4 sm:px-6 md:px-8 lg:px-12 bg-black">
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          {/* Supporting copy */}
          <p className="text-lg sm:text-xl md:text-2xl font-light text-white/80 max-w-3xl mx-auto leading-relaxed px-2">
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center pt-6 sm:pt-8">
            <Link href="/find-your-center" className="w-full sm:w-auto">
              <motion.button 
                className="group relative text-black text-sm tracking-widest uppercase font-medium w-full touch-manipulation"
                whileHover={{ scale: 1.02 }}
                transition={{ duration: 0.2 }}
              >
                <span className="relative z-10 px-8 sm:px-10 py-4 block bg-white text-black">Find Your Center</span>
            ...
            <Link href="/our-centers" className="w-full sm:w-auto">
              <motion.button 
                className="group relative text-white text-sm tracking-widest uppercase font-medium w-full touch-manipulation"
                whileHover={{ scale: 1.02 }}
                transition={{ duration: 0.2 }}
              >
