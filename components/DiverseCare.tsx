      ...
      <div className="max-w-6xl mx-auto relative">
        ...
        >
          ...
          >
            ...
            <div className="group relative p-8 rounded-2xl bg-white hover:bg-gradient-to-b hover:from-white hover:to-[#F9FAF9] transition-all duration-500">
              ...
              <div className="relative space-y-6">
                ...
                <div>
                  <h3 className="text-xl font-light text-[#06402B] mb-3">Clinical to Holistic</h3>
                  <p className="text-black/70 leading-relaxed">Spanning evidence-based medical treatment to integrative healing practices</p>
                </div>
            ...
            <div className="group relative p-8 rounded-2xl bg-white hover:bg-gradient-to-b hover:from-white hover:to-[#F9FAF9] transition-all duration-500">
              ...
              <div className="relative space-y-6">
                ...
                <div>
                  <h3 className="text-xl font-light text-[#06402B] mb-3">Accessible to Luxury</h3>
                  <p className="text-black/70 leading-relaxed">Treatment options across different price points without compromising quality</p>
                </div>
                <div className="w-12 h-[1px] bg-gradient-to-r from-[#B7C9B7]/30 to-transparent mx-auto opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              </div>
            </div>
            ...
            <div className="group relative p-8 rounded-2xl bg-white hover:bg-gradient-to-b hover:from-white hover:to-[#F9FAF9] transition-all duration-500">
              ...
              <div className="relative space-y-6">
                ...
                <div>
                  <h3 className="text-xl font-light text-[#06402B] mb-3">Urban to Nature</h3>
                  <p className="text-black/70 leading-relaxed">Settings spanning urban accessibility to pristine natural environments for healing</p>
                </div>
                <div className="w-12 h-[1px] bg-gradient-to-r from-[#B7C9B7]/30 to-transparent mx-auto opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              </div>
            </div>
